...
//取某一列的所有数据
    ...
    function getNumbers(column) {
        ...
        var number = 0;
        for (var index = 0; index < rows.length; index++) {
            var str=rows[index]['groupDate'].substring(0,7)
            console.log(str)
            if ((rows[index]['groupDate']).substring(0,7) == column) {
    ...
    var methodObj = {
        ...
        exportXls: function () {
            ...
            var str="/newChart/export.do"+"?keyword="+keyword+"&beginTime="+beginTime+"&endTime="+endTime+"&groupMssage="+groupMssage;*/
