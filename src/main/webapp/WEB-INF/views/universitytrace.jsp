...
<div id="universitytrace_toolbar">
    ...
    <a class="easyui-linkbutton" data-cmd="remove" data-options="plain:true,iconCls:'icon-remove'">删除</a>
    ...
    <input id="keyword" class="easyui-textbox"
           data-options="prompt:'学校/地址'" name="keyword">
    意向学科:<input id="subjectId" class="easyui-combobox"
                data-options="url:'/systemdictionaryitem/selectItemByParentSn.do?sn=subject',valueField:'id',textField:'name',panelHeight:'auto',prompt:'意向学科'"
                name="subject.id">
...
<div id="universitytraceTraceAll_dialog">
    <form id="universitytrace_form" method="post" style="width:880px;height:400px;">
        <input type="hidden" name="id">
        <table align="center" style="margin-top: 20px;width: 100%" cellspacing="5px" cellpadding="5px">
            <tr align="right" style="height: 45px">
                <td><span style="font-size: 14px">名称:</span></td>
                <td><input class="easyui-textbox" name="name" style="width: 145px;height: 35px;"/></td>
                <td><span style="font-size: 14px">地址:</span></td>
                <td><input class="easyui-textbox" name="address" style="width: 145px;height: 35px;"/></td>
                <td><span style="font-size: 14px">重要性:</span></td>
                <td><input class="easyui-combobox" name="importance.id" style="width: 145px;height: 35px;"
            ...
            <tr align="right" style="height: 45px">
                ...
                <td><input class="easyui-combobox" name="wantedlevel.id" style="width: 145px;height: 35px;"
                           data-options="url:'/systemdictionaryitem/selectItemByParentSn.do?sn=intentionDegree',textField:'name',valueField:'id',panelHeight:'auto'"/>
                </td>
                <td><span style="font-size: 14px">意向学科:</span></td>
                <td><input class="easyui-combobox" name="subject.id" style="width: 145px;height: 35px;"
                ...
                <td><input class="easyui-combobox" name="college.id" style="width: 145px;height: 35px;"
                           data-options="url:'/systemdictionaryitem/selectItemByParentSn.do?sn=college',textField:'name',valueField:'id',panelHeight:'auto'"/>
                </td>
            </tr>
            <tr align="right" style="height: 45px">
                <td><span style="font-size: 14px">联系人:</span></td>
                <td><input class="easyui-combobox" name="contact.id" style="width: 145px;height: 35px;"
                           data-options="url:'/schoolContacts/selectAll.do',textField:'contactsName',valueField:'id',panelHeight:'auto'"/>
                </td>
                <td><span style="font-size: 14px">营销人员:</span></td>
                <td><input class="easyui-combobox" name="marketer.id" style="width: 145px;height: 35px;"
                ...
                <td><input class="easyui-combobox" name="tracer.id" style="width: 145px;height: 35px;"
                           data-options="url:'/employee/selectAll.do',textField:'username',valueField:'id',panelHeight:'auto'"/>
                </td>
            </tr>
            <tr align="right" style="height: 45px">
                <td><span style="font-size: 14px">上次跟进日期:</span></td>
                <td><input class="easyui-datetimebox" name="prevtrancetime" style="width: 145px;height: 35px;"/></td>
                <td><span style="font-size: 14px">下次跟进日期:</span></td>
                <td><input class="easyui-datetimebox" name="nexttrancetime" style="width: 145px;height: 35px;"/></td>
                <td><span style="font-size: 14px">跟进状态:</span></td>
                <td>
                    <select class="easyui-combobox" id="un_traceState" name="tracestate"
                            style="width: 145px;height: 35px;" data-options="panelHeight:'auto'">
            ...
            <tr align="right" style="height: 45px">
                ...
                <td><input class="easyui-textbox" name="schooltel" style="width: 145px;height: 35px;"/></td>
                <td><span style="font-size: 14px">邮箱:</span></td>
                <td><input class="easyui-validatebox easyui-textbox" name="email" style="width: 145px;height: 35px;"
                           data-options="validType:'email'"
                /></td>
            </tr>
            <tr align="right" style="height: 45px">
                <td><span style="font-size: 14px">学生数:</span></td>
                <td><input class="easyui-textbox" name="stunumber" style="width: 145px;height: 35px;"/></td>
                <td><span style="font-size: 14px">it专业学生数:</span></td>
                <td><input class="easyui-textbox" name="itstunumber" style="width: 145px;height: 35px;"/></td>
                <td><span style="font-size: 14px">学校类型:</span></td>
                <td><input class="easyui-combobox" name="type.id" style="width: 145px;height: 35px;"
                           data-options="url:'/systemdictionaryitem/selectItemByParentSn.do?sn=type',textField:'name',valueField:'id',panelHeight:'auto'"/>
                </td>
            </tr>
            <tr align="right" style="height: 45px">
                <td><span style="font-size: 14px">传真:</span></td>
                <td><input class="easyui-textbox" name="telegraph" style="width: 145px;height: 35px;"/></td>
                <td><span style="font-size: 14px">邮政编码:</span></td>
                <td><input class="easyui-textbox" name="postcode" style="width: 145px;height: 35px;"/></td>
                <td><span style="font-size: 14px">教师数量:</span></td>
                <td><input class="easyui-textbox" name="teachernumber" style="width: 145px;height: 35px;"/></td>
            </tr>
            <tr align="right" style="height: 80px">
                <td><span style="font-size: 14px">备注:
                <td colspan="6" align="left"><input type="textarea" name="remark"
                                                    style="height: 50px;width: 657px"/>
                </td>
            </tr>
            <tr align="right">
...
<div id="universitytrace_import">
    <form action="/universitytrace/importXls1.do" method="post" enctype="multipart/form-data">
        ...
        <a class="easyui-linkbutton" iconCls="icon-download" plain="true" data-cmd="download">模板下载</a><br>
